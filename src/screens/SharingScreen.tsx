        ...
        {activeTab === 'events' && (
          <div>
              ...
              <div className="mb-4">
                ...
                <div className="flex gap-2 overflow-x-auto pb-2">
                  <button
                    ...
                    className={`px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-all ${
                      activeCategory === 'yoga'
                        ...
                        : `${glassBase} ${isDark ? 'text-gray-200' : 'text-gray-700'} shadow-md`
                    }`}
                    style={activeCategory === 'yoga' ? { background: `linear-gradient(135deg, ${colors.gradientFrom} 0%, ${colors.gradientTo} 100%)` } : {}}
                  >
                  ...
                  <button
                    ...
                    style={activeCategory === 'religious' ? { background: `linear-gradient(135deg, ${colors.gradientFrom} 0%, ${colors.gradientTo} 100%)` } : {}}
                  >
                    🕉️ Religious Places
                  </button>
                  <button
                    ...
                    style={activeCategory === 'meditation' ? { background: `linear-gradient(135deg, ${colors.gradientFrom} 0%, ${colors.gradientTo} 100%)` } : {}}
                  >
            ...
            {selectedLocality && activeCategory && (
              <div className="mb-6">
                {placesError && (
                  <div className={`${glassBase} rounded-2xl p-4 mb-4 shadow-lg`} style={{
                    background: isDark
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="flex-1">
                        <h4 className={`font-semibold mb-1 ${isDark ? 'text-red-300' : 'text-red-900'}`}>Error Loading Places</h4>
                        <p className={`text-sm ${isDark ? 'text-red-200' : 'text-red-700'}`}>{placesError}</p>
                        <button
                          onClick={() => {
                            setPlacesError(null)
                            setActiveCategory(null)
                          }}
                          className={`mt-2 text-xs font-medium transition-colors ${isDark ? 'text-red-300 hover:text-red-100' : 'text-red-600 hover:text-red-800'}`}
                        >
                          Try Again
                        </button>
                      </div>
                ...
                {isLoadingPlaces ? (
                  <div className={`${glassBase} rounded-2xl p-8 text-center shadow-lg`}>
                    ...
                    <p className={`text-sm ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>Finding places in {selectedLocality}...</p>
                  </div>
                ) : (
                  <div className="space-y-3">
                    {activeCategory === 'yoga' && yogaCenters.length > 0 && (
                      <>
                        ...
                        {yogaCenters.map((place, index) => (
                          <div
                            key={`yoga-${index}`}
                            className={`${glassBase} rounded-2xl p-4 hover:shadow-xl transition-all duration-300 hover:scale-[1.02]`}
                            style={{
                              background: isDark
                                ? `linear-gradient(135deg, rgba(16, 185, 129, 0.15) 0%, rgba(20, 184, 166, 0.1) 100%)`
                                : `linear-gradient(135deg, rgba(16, 185, 129, 0.2) 0%, rgba(20, 184, 166, 0.15) 100%)`
                            }}
                          >
                            <div className="flex items-start justify-between mb-2">
                              <h4 className={`font-semibold flex-1 pr-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>{place.name}</h4>
                              {place.rating && (
                                <span className={`px-2 py-0.5 ${glassBase} text-xs rounded-full whitespace-nowrap shadow-sm`} style={{ color: '#10b981' }}>
                                  ⭐ {place.rating}
                                </span>
                              )}
                            </div>
                            <div className="space-y-1.5 text-sm">
                              ...
                              {place.phone && (
                                <div className={`flex items-center ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                                  <span className="mr-2">📞</span>
                                  <a href={`tel:${place.phone}`} className="hover:underline" style={{ color: colors.primary }}>
                                    {place.phone}
                                  </a>
                                </div>
                              )}
                          ...
                          <div
                            ...
                            style={{
                              background: isDark
                                ...
                                : `linear-gradient(135deg, rgba(249, 115, 22, 0.2) 0%, rgba(251, 146, 60, 0.15) 100%)`
                            }}
                          >
                            <div className="flex items-start justify-between mb-2">
                              <h4 className={`font-semibold flex-1 pr-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>{place.name}</h4>
                              {place.rating && (
                                <span className={`px-2 py-0.5 ${glassBase} text-xs rounded-full whitespace-nowrap shadow-sm`} style={{ color: '#f97316' }}>
                                  ⭐ {place.rating}
                                </span>
                              )}
                            </div>
                            <div className="space-y-1.5 text-sm">
                              ...
                              {place.distance && (
                                <div className="flex items-center font-medium" style={{ color: '#f97316' }}>
                                  <span className="mr-2">🚶</span>
                                  <span>{formatDistance(place.distance)}</span>
                                </div>
                              )}
                              <div className={`flex items-center ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                                ...
                                <span className={`text-xs ${glassBase} px-2 py-0.5 rounded-full shadow-sm`} style={{ color: '#f97316' }}>
                                  {place.type}
                                </span>
                              </div>
                            </div>
                    ...
                    {((activeCategory === 'yoga' && yogaCenters.length === 0) ||
                      ...
                      <div className={`${glassBase} rounded-2xl p-8 text-center shadow-lg`}>
                        ...
                        <h3 className={`font-semibold mb-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>No Places Found</h3>
